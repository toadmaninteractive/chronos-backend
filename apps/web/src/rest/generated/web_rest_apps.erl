...
handle_get(Req) ->
    try
        Response = web_rest_callback_apps:get_applications(),
        Body = jsx:encode(igor_json:pack_value(Response, {list, {custom, fun web_protocol:application_to_json/1}})),
