...
handle_get(Req) ->
    try
        ...
        Response = web_rest_callback_errors:get_errors(App, Component, Branch, Versions, DateFrom, DateTo, Search, Offset, Limit),
        Body = jsx:encode(igor_json:pack_value(Response, {list, {custom, fun web_protocol:error_entry_to_json/1}})),
