...
-module(web_rest_crash_reports_pdb).
...
handle_get(Req) ->
    try
        ...
        ResponseContent = web_rest_callback_crash_reports:get_crash_report_pdb(App, Component, Branch, Version),
        Body = jsx:encode(data_protocol:collection_to_json(ResponseContent, string)),
